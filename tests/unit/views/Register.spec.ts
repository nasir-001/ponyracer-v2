...
describe('Register.vue', () => {
  ...
  test('should have an errors computed property', () => {
    const wrapper = registerWrapper();
    wrapper.vm.userModel.login = 'cedric';
    wrapper.vm.userModel.birthYear = 0;
    ...
    wrapper.vm.userModel.login = '';
    wrapper.vm.userModel.password = 'pwd';
    wrapper.vm.userModel.birthYear = 1986;
    const errorsUpdated = wrapper.vm.errors;
    expect(errorsUpdated.login).toBeTruthy();
  ...
  test('should update the dirtiness of a field', () => {
    ...
    expect(dirty.birthYear).toBeTruthy();
  ...
  test('should display errors for login', async () => {
    ...
    expect(wrapper.vm.userModel.login).toBe('cedric');
  });
  ...
  test('should display errors for birthYear', async () => {
    ...
    expect(wrapper.vm.userModel.birthYear).toBe(1986);
  });
